            ...
            <div className="block md:hidden space-y-2">
              ...
              <div className="p-2 bg-zinc-50 dark:bg-black/10 rounded-2xl">
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  {perfil?.dieta_alimentaria && perfil.dieta_alimentaria.length > 0 ? perfil.dieta_alimentaria.map((d: string) => (<span key={d} className="px-2 py-0.5 bg-clr7/50 text-clr9 rounded text-[0.8em] uppercase font-bold">{d}</span>)) : <span className="text-[0.8em] italic opacity-40 font-bold">Sin restricciones</span>}
                </div>
              </div>
            </div>
            {/* Desktop */}
