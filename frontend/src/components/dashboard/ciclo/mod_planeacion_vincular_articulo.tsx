...
export default function DashModVincularArticulo({ isOpen, onClose, propuestaId, onSuccess, unidadNombre }: DashModVincularArticuloProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-[130] flex items-center justify-center p-2 animate-in fade-in duration-300">
      <div className="bg-white dark:bg-dclr5 w-full max-w-4xl rounded-[1rem] p-2 md:p-2 shadow-2xl overflow-y-auto max-h-[90vh]">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 bg-zinc-50 dark:bg-black/20 p-2 rounded-[1rem] border border-zinc-100 dark:border-dclr10">
            <div className="relative">
              <input 
                ...
                className="w-full p-3 pl-4 rounded-xl border bg-white dark:bg-dclr10 font-bold text-sm focus:ring-2 ring-clr6 outline-none transition-all"
              />
            </div>
            <div className="relative">
              <select
                ...
                className="w-full p-3 rounded-xl border bg-white dark:bg-dclr10 font-black text-[1em] uppercase tracking-widest focus:ring-2 ring-clr6 outline-none transition-all"
              >
                ...
                filteredActividades.map(art => (
                  ...
                  >
                    <div className="flex gap-2">
                      ...
                      <div>
                        <h4 className="font-bold uppercase text-[1em] leading-tight text-clr5 dark:text-dclr2">{art.titulo}</h4>
