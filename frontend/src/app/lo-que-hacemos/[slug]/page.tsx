      ...
      <PageTemplate title={metadata.title || slug}>
        <article className="space-y-8">
          ...
          <header className="flex flex-col md:flex-row gap-8 md:items-center">
            {metadata.image && (
              <div className="shrink-0 w-full md:w-[350px] lg:w-[450px] aspect-square rounded-[3rem] overflow-hidden shadow-2xl border-4 border-clr1 dark:border-dclr1">
                <img 
                  src={metadata.image} 
                  alt={metadata.title} 
            ...
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-6xl font-black font-display text-clr4 dark:text-dclr4 uppercase tracking-tighter leading-none">
                {metadata.title}
              </h1>
          ...
          <div className="max-w-none pt-12 border-t border-clr7 dark:border-dclr7">
