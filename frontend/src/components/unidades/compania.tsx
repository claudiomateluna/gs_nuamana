  ...
  return (
    <div className="space-y-2">
      <div className="space-y-2">
        ...
        <p className="text-[1.05em] leading-relaxed text-clr2 dark:text-dclr2">El perfil a grandes trazos describe las características de las guías en este período de desarrollo (11 a 15 años) según los distintos aspectos de su personalidad, ordenados para acompañar su crecimiento:</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pt-1">
        {[{ title: "Un Cuerpo Nuevo", desc: "El cuerpo se renueva cada día. En él pasan cosas que desconciertan, que invitan a la exploración, que empujan al extremo de los propios límites, que revelan la belleza y hacen surgir el pudor. El cansancio es un invitado permanente, la presentación personal las inquieta y la ropa parece no quedarles nunca." },{ title: "Ideas Emergentes", desc: "El mundo mental crece. Las ideas tienen vida propia y se pueden combinar en abstracciones. Las preguntas, antes orientadas al exterior, se concentran en sí mismas: ¿Quién soy? ¿Cómo soy? Cuestionan todo aquello que antes asumían como una verdad indiscutible." },{ title: "Valores Propios", desc: "Lo correcto e incorrecto es objeto de dudas y preguntas. Surge la capacidad de ponerse en el lugar del otro. Se inicia la construcción de un código de conducta asumido personalmente, independiente de la opinión familiar y basado en el diálogo con sus pares." },{ title: "Emociones Contradictorias", desc: "El mundo interior cobra fuerza con oleadas sentimentales intensas y perdurables que desconciertan y descontrolan. Se definen por amar el amor, odiar el odio, ser 'amiga de las amigas y enemiga de las enemigas', en una etapa de búsqueda de identidad propia." },{ title: "Amigas para la Vida", desc: "En las amigas se cree, se confía y se descansa. Los círculos de amistad son más reducidos pero mucho más profundos, funcionando como espejo y motor del desarrollo. Surge cierta distancia defensiva o confrontación con el entorno familiar inmediato." },{ title: "Una Fe Personal", desc: "Tránsito entre la fe infantil heredada del hogar y la fe del adulto, personal e íntima. Se vive en la dualidad entre la crítica permanente a la forma exterior y la búsqueda constante del sentido interior, distinguiendo la creencia propia de la del adulto." }].map((item, idx) => (
          <div key={idx} className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-2 shadow-md space-y-2 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-2 h-full" style={{ backgroundColor: secundario }} />
            <h4 className="font-extrabold uppercase text-[1.1em] text-clr2 dark:text-dclr2 ml-2" style={{ backgroundColor: primario, color: secundario, padding: '0.25rem 0.5rem', borderRadius: '0.5rem' }}>{item.title}</h4>
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-[1.05em] leading-relaxed text-clr2 dark:text-dclr2">En el Movimiento Guía y Scout aspiramos a que, al finalizar tu paso por la Compañía y el Grupo, seas capaz de forjar tu propio proyecto de vida basándote en los siguientes pilares de la personalidad:</p>
      </div>
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-[1.05em] leading-relaxed text-clr2 dark:text-dclr2">La progresión personal se organiza en seis áreas de desarrollo. Cada una posee un símbolo protector en la naturaleza de la Compañía. Descubre tus objetivos y desafíate a explorar nuevos caminos junto a tu patrulla.</p>
      </div>
      <div className="space-y-8">
        {areas.map((area) => {
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-[1.05em] leading-relaxed text-clr2 dark:text-dclr2">En la Compañía, el juego democrático y el protagonismo de las guías organizan la vida común. A través de ciclos que ocurren tres veces al año, planificamos, preparamos, desarrollamos y evaluamos nuestras aventuras.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-4">
            <h4 className="font-extrabold uppercase text-[1.2em] text-clr2 dark:text-dclr2" style={{ color: primario }}>Las Actividades de Compañía: Deben ser DURAS</h4>
            <p className="text-[0.98em] text-clr2 dark:text-dclr2 leading-relaxed">Los proyectos son actividades de mediana o larga duración organizadas por las patrullas. Deben cumplir con el criterios de ser <strong>DURAS</strong>:</p>
          ...
          <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-4">
            ...
            <div className="space-y-3 text-[0.95em]">
              <div className="space-y-1"><span className="font-bold text-clr2 dark:text-dclr2 block text-[0.95em]">📌 Actividades Fijas:</span><p className="text-[0.9em] text-clr3 dark:text-dclr3 leading-relaxed pl-3 border-l-2 border-clr7 dark:border-dclr7">Rutinas constantes que estructuran la vida de la unidad: Reuniones de Patrulla y Compañía, Campamentos, Excursiones al aire libre y la tradicional Fiesta del Trébol.</p></div>
              <div className="space-y-1"><span className="font-bold text-clr2 dark:text-dclr2 block text-[0.95em]">🎨 Actividades Variables:</span><p className="text-[0.9em] text-clr3 dark:text-dclr3 leading-relaxed pl-3 border-l-2 border-clr7 dark:border-dclr7">Elegidas específicamente para responder al Énfasis del Ciclo. Ejemplos: reciclaje ecológico, safaris fotográficos, talleres de nudos, deportes de aventura o proyectos solidarios locales.</p></div>
            </div>
          </div>
        </div>
      </div>
...
function CiaMistica({ primario, secundario }: { primario: string; secundario: string }) {
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-4">
          <span className="text-[0.8em] font-black uppercase tracking-widest px-3 py-1 rounded-full bg-clr4 dark:bg-dclr4 text-clr4 dark:text-dclr4 border border-clr4 dark:border-dclr4">Compromiso de Honor</span>
          <h4 className="font-extrabold uppercase text-[1.3em] text-clr2 dark:text-dclr2 leading-tight">La Promesa Guía</h4>
          <p className="text-[1.08em] leading-relaxed text-clr2 dark:text-dclr2 italic pl-4 border-l-2 border-clr4">"Hacer cuanto de mí dependa para buscar a Dios, amar a mi familia, ayudar a los demás, servir a mi país, trabajar por la paz y vivir la Ley Guía."</p>
        </div>
        <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-4">
          ...
          <h4 className="font-extrabold uppercase text-[1.3em] text-clr2 dark:text-dclr2 leading-tight">La Ley Guía</h4>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-3 relative overflow-hidden"><div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: primario }} /><h4 className="font-extrabold uppercase text-[1.1em] text-clr2 dark:text-dclr2 pl-2">El Color Cian</h4><p className="text-[0.9em] text-clr2 dark:text-dclr2 leading-relaxed pl-2">Es la mezcla exacta de verde y azul claro: los colores más significativos del entorno de exploración de las guías en la naturaleza.</p></div>
        <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-3 relative overflow-hidden"><div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: secundario }} /><h4 className="font-extrabold uppercase text-[1.1em] text-clr2 dark:text-dclr2 pl-2">El Trébol Mundial</h4><p className="text-[0.9em] text-clr2 dark:text-dclr2 leading-relaxed pl-2">Símbolo de la Asociación Mundial (WAGGGS). Sus tres hojas recuerdan los principios de la promesa, y su aguja en el centro representa la brújula.</p></div>
        <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-3 relative overflow-hidden"><div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: primario }} /><h4 className="font-extrabold uppercase text-[1.1em] text-clr2 dark:text-dclr2 pl-2">Saludo de Mano Izquierda</h4><p className="text-[0.9em] text-clr2 dark:text-dclr2 leading-relaxed pl-2">Seña de confianza heredada del pueblo Ashanti: al saludar con la mano izquierda, el guerrero dejaba de lado su escudo protector.</p></div>
      </div>
      ...
      <div className="bg-clr1 dark:bg-clr1 border border-clr7 dark:border-dclr7 rounded-3xl p-6 space-y-4 relative overflow-hidden">
        ...
        <h4 className="font-extrabold uppercase text-[1.2em] text-clr2 dark:text-dclr2 pl-2">Himno de la Rama: Siempre Lista</h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[0.95em] pl-2">
          <div className="space-y-1"><span className="font-bold text-clr2 dark:text-dclr2 block text-[0.9em] uppercase tracking-wide">Coro</span><p className="italic text-clr2 dark:text-dclr2 leading-relaxed pl-3 border-l border-clr7 dark:border-dclr7">Siempre lista, hermana guía,<br />es el deber nuestra misión,<br />ser la luz que brilla y brilla<br />por la Patria y el honor.<br />A la cumbre subiremos<br />sin descanso hasta el final<br />con el alma siempre abierta<br />en pos de nuestro ideal.</p></div>
          <div className="space-y-1"><span className="font-bold text-clr2 dark:text-dclr2 block text-[0.9em] uppercase tracking-wide">Estrofa I</span><p className="italic text-clr2 dark:text-dclr2 leading-relaxed pl-3 border-l border-clr7 dark:border-dclr7">Guías, avanzad en alegre caravana<br />porque la luz nos espera al final<br />siempre en la paz, amor y amistad<br />el triunfo será de nuestra hermandad.</p></div>
        </div>
      </div>
      <div className="relative rounded-[2rem] overflow-hidden border border-clr7 dark:border-dclr7 bg-clr2 shadow-xl" style={{ minHeight: '280px' }}>
        ...
        <div className="relative z-10 p-8 sm:p-10 flex flex-col justify-end h-full space-y-4 max-w-2xl bg-gradient-to-t from-clr2 via-clr2 to-transparent">
          <span className="text-[0.8em] font-black uppercase tracking-widest px-3 py-1 rounded-full bg-clr4 text-clr4 border border-clr4 self-start">Símbolo de Unidad</span>
          <h4 className="text-[1.5em] font-black uppercase tracking-tight text-clr1 leading-tight">La Bandera de la Compañía</h4>
          <p className="text-[1.02em] leading-relaxed text-clr7">La bandera oficial de la Rama lleva como fondo el color <strong>cian</strong> y en su centro, en amarillo dorado, el <strong>trébol</strong> de la insignia Guía Mundial.</p>
        </div>
      </div>
    </div>
  );
