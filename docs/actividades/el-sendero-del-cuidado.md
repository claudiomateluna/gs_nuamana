...
objetivos_generales: ["Facilitar el contacto inicial", "Estimular la confianza", "Fomentar un entorno de confianza", "Fomentar las relaciones interpersonales", "Permitir el contacto físico", "Crear un ambiente de distensión"]
