    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'dclr5', label: 'Oscuro 5 — Azul Noche Oscuro', type: 'color', tooltip: 'Encabezados y secciones en modo oscuro (var(--dclr5))' },
          { key: 'dclr6', label: 'Oscuro 6 — Verde Oscuro', type: 'color', tooltip: 'Verde de éxito en modo oscuro (var(--dclr6))' },
          { key: 'dclr7', label: 'Oscuro 7 — Acento (Rojo Oscuro)', type: 'color', tooltip: 'Color de acento principal en modo oscuro (var(--dclr7))' },
          { key: 'dclr8', label: 'Oscuro 8 — Dorado Oscuro', type: 'color', tooltip: 'Dorado para destacados en modo oscuro (var(--dclr8))' },
        ],
      },
    ],
  },
