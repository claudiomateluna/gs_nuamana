...
# 5-WAY CROSSING MATRIX FOR "DESAFÍO DE LAS CUATRO COLINAS"
# 3 Core Umbrellas (texto_terminal):
# 1. Creatividad: "Contribuye a preservar la vida a través de la conservación de la integridad del mundo natural."
# 2. Corporalidad: "Convive constantemente en la naturaleza y participa en actividades deportivas y recreativas."
# 3. Carácter: "Reconoce en su grupo de pertenencia un apoyo para su crecimiento personal y para la realización de su proyecto de vida."

objetivos_educativos = [
    # =========================================================================
    # 🌲 UMBRELLA 1: CREATIVIDAD (Medioambiente y Conservación)
    # =========================================================================
    # --- Tropa (11 a 13 años) ---
    {
    ...
    # --- Tropa (13 a 15 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Diseñando rutas de avance sigilosas con mi patrulla sin alterar ni dañar el entorno boscoso."
    },
    # --- Compañía (11 a 13 años) ---
    {
        ...
        "texto": "Conozco los diferentes ecosistemas de mi país.",
        "unidad": "Compañía",
        "como_se_cumple": "Utilizando las sombras del bosque y el relieve de la colina para el avance de la patrulla."
    },
    # --- Compañía (13 a 15 años) ---
    {
        ...
        "texto": "Aplico técnicas que me permiten mejorar el medioambiente y no dañar los lugares en que acampo.",
        "unidad": "Compañía",
        "como_se_cumple": "Ideando tácticas de infiltración respetuosas con la vegetación del terreno acotado."
    },
    # --- Avanzada (15 a 17 años) ---
    {
        ...
        "unidad": "Avanzada",
        "como_se_cumple": "Estructurando técnicas de orientación nocturna respetando la flora y fauna silvestre."
    },
    # --- Clan (17 a 20 años) ---
    {
        "id": "c4f78e61-6790-4cf4-b477-993900b5bf02",
        "area": "Creatividad",
        "texto": "Contribuyo a preservar la vida a través de la conservación de la integridad del mundo natural.",
        "unidad": "Clan",
        "como_se_cumple": "Promoviendo el cuidado ambiental y la integración ética con la naturaleza durante las actividades de campamento."
    },

    # =========================================================================
    # 🏃 UMBRELLA 2: CORPORALIDAD (Naturaleza y Actividad Física)
    # =========================================================================
    # --- Tropa (11 a 13 años) ---
    {
    ...
    # --- Tropa (13 a 15 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Moviéndome con destreza y seguridad en la penumbra sin poner en riesgo mi integridad física."
    },
    # --- Compañía (11 a 13 años) ---
    {
    ...
    # --- Compañía (13 a 15 años) ---
    {
        "id": "2d033cc1-87bb-4990-846e-bbac8a4249fe",
        "area": "Corporalidad",
        "texto": "Ayudo a preparar los juegos, excursiones y campamentos de mi patrulla y mi Compañía.",
        "unidad": "Compañía",
        "como_se_cumple": "Coordinando el despliegue físico ágil de las guías para vulnerar el perímetro de observación."
    },
    # --- Avanzada (15 a 17 años) ---
    {
        ...
        "unidad": "Avanzada",
        "como_se_cumple": "Liderando desplazamientos físicos exigentes y dinámicas recreativas nocturnas con la comunidad caminante."
    },
    # --- Clan (17 a 20 años) ---
    {
        ...
        "unidad": "Clan",
        "como_se_cumple": "Ejercitando la aptitud física y la convivencia al aire libre durante las pruebas nocturnas del clan."
    },

    # =========================================================================
    # ⚜️ UMBRELLA 3: CARÁCTER (Grupo de Pertenencia y Superación)
    # =========================================================================
    # --- Tropa (11 a 13 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Superando el temor a la oscuridad y manteniendo la calma bajo las indicaciones del equipo."
    },
    # --- Tropa (13 a 15 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Manteniendo la disciplina del silencio y apoyando a mis compañeros durante el acecho."
    },
    # --- Compañía (11 a 13 años) ---
    {
        ...
        "texto": "Aprecio los consejos que me dan en mi patrulla.",
        "unidad": "Compañía",
        "como_se_cumple": "Escuchando las sugerencias tácticas de la patrulla para actuar con temple en la penumbra."
    },
    # --- Compañía (13 a 15 años) ---
    {
        ...
        "unidad": "Compañía",
        "como_se_cumple": "Brindando confianza y contención a las integrantes de la patrulla durante la infiltración."
    },
    # --- Avanzada (15 a 17 años) ---
    {
        ...
        "unidad": "Avanzada",
        "como_se_cumple": "Aportando serenidad, autodisciplina y toma de decisiones tácticas frente a situaciones de presión."
    },
    # --- Clan (17 a 20 años) ---
    {
        ...
        "unidad": "Clan",
        "como_se_cumple": "Coordinando con fraternidad la estrategia de acecho con mis pares de clan y fortaleciendo la confianza del grupo."
    }
]
...
with open("supabase/import_cuatro_colinas_v8.sql", "wb") as f:
    f.write(sql_script.encode("utf-8"))

print("V8 SQL generated with 3 clean umbrellas for all 4 declared units (18 goals).")
