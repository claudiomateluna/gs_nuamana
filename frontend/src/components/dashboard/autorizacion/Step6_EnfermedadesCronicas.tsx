        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            {opcionesEnfermedades.map(opt => {
              ...
              return (
                <label key={opt} className={`p-3 border-2 rounded-xl text-center cursor-pointer font-bold text-[0.85em] uppercase transition-all ${isChecked ? 'border-pclr14 bg-pclr10 text-pclr12 shadow-md' : 'border-pclr13 dark:border-pdclr13 dark:text-pdclr4 hover:border-pclr14'}`}>
