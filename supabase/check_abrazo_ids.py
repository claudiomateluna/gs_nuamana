...
cmd = ["docker", "exec", "-i", "supabase_db_nuamana-local", "psql", "-U", "postgres", "-d", "postgres", "-t", "-A", "-c", "SELECT metadata->'objetivos_educativos' FROM articulos WHERE slug = 'el-abrazo-musical';"]
