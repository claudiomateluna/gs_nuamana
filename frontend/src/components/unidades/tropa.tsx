...
interface TropaCustomContentProps { objectives: Objective[]; }
  ...
  return (
    <UnitView
      ...
      tabs={[
        ...
        { key: 'mistica', label: 'Símbolos', content: <TropaMistica primario={primario} /> },
      ]}
    />
  );
}
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-[1.05em] leading-relaxed text-zinc-700 dark:text-zinc-300">El perfil a grandes trazos describe las características reales y comportamientos de los scouts en este período de desarrollo (11 a 15 años), abarcando todos los aspectos de su personalidad:</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
        {[{ title: "Un Cuerpo Nuevo", desc: "El cuerpo se renueva y crece a pasos agigantados. En él ocurren cambios que desconciertan y llaman a la exploración. El cansancio es un compañero constante, la torpeza motriz (desgarbo) es habitual y les preocupa enormemente la apariencia física y la aceptación de los demás." },{ title: "Ideas Emergentes", desc: "Se expande la mente y aparece la capacidad de pensar en abstracto. Los jóvenes combinan conceptos y reflexionan de forma autónoma. El foco de sus preguntas pasa a ser interno: ¿Quién soy? ¿Cómo me ven los otros? Comienzan a cuestionar los dogmas y verdades previas." },{ title: "Valores Propios", desc: "Aparecen dudas éticas e inquietudes sobre lo correcto e incorrecto. Se desarrolla la empatía y la capacidad de situarse en el lugar del otro. Empieza la formulación de una moral propia, dialogada con el grupo de iguales y distante del patrón puramente familiar." },{ title: "Emociones Contradictorias", desc: "El mundo afectivo experimenta sentimientos de gran intensidad que cambian de un momento a otro. Domina el 'amar el amor' y el 'odiar el odio'. Ser incondicional con los amigos íntimos y distante con lo que no encaja en su búsqueda de identidad." },{ title: "Amigos para la Vida", desc: "El grupo de amigos se vuelve el refugio de confianza absoluta. Las relaciones son intensas y selectivas. Los pares ejercen un rol de validación indispensable para la autoimagen, generando a veces roces o distancia frente a los padres y el hogar." },{ title: "Una Fe Personal", desc: "Tránsito progresivo de la religiosidad infantil (heredada de la familia) a una vivencia espiritual propia. Hay una doble actitud: críticas a la institucionalidad y formas de culto externas, pero una sed profunda de encontrar sentido interior y conexión con Dios." }].map((item, idx) => (
          <div key={idx} className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 shadow-md space-y-2 relative overflow-hidden">
            ...
            <h4 className="font-extrabold uppercase text-[1.1em] text-zinc-900 dark:text-white pl-2">{item.title}</h4>
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-[1.05em] leading-relaxed text-zinc-700 dark:text-zinc-300">El proyecto educativo del Movimiento Scout propone que cada joven construya de forma autónoma su propio proyecto de vida, orientando su carácter hacia los siguientes ideales:</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-[1.05em] leading-relaxed text-zinc-700 dark:text-zinc-300">La progresión personal se organiza en seis áreas de desarrollo. En cada una, la Tropa utiliza un símbolo de identidad nacional y local para representar tu crecimiento personal.</p>
      </div>
      <div className="space-y-4">
        {areas.map((area) => {
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-[1.05em] leading-relaxed text-zinc-700 dark:text-zinc-300">La Tropa es una escuela de democracia y autogobierno donde los muchachos eligen y conducen su programa de actividades a través de ciclos estructurados en 4 fases sucesivas.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-4">
            <h4 className="font-extrabold uppercase text-[1.2em] text-zinc-900 dark:text-white" style={{ color: primario }}>Los Proyectos de Tropa: DURAS</h4>
            <p className="text-[0.98em] text-zinc-650 dark:text-zinc-400 leading-relaxed">Los proyectos (o Aventuras) de Tropa son actividades de mediana o larga duración. Deben cumplir con los criterios <strong>DURAS</strong>:</p>
          ...
          <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-4">
            ...
            <div className="space-y-3 text-[0.95em]">
              <div className="space-y-1"><span className="font-bold text-zinc-800 dark:text-zinc-200 block text-[0.95em]">📌 Actividades Fijas:</span><p className="text-[0.9em] text-zinc-550 dark:text-zinc-400 leading-relaxed pl-3 border-l-2 border-zinc-200 dark:border-white/10">Rutinas que estructuran el programa: Reuniones de Patrulla y de Tropa, Campamentos y excursiones, juegos scouts de despliegue físico y fogones.</p></div>
              <div className="space-y-1"><span className="font-bold text-zinc-800 dark:text-zinc-200 block text-[0.95em]">🎨 Actividades Variables:</span><p className="text-[0.9em] text-zinc-550 dark:text-zinc-400 leading-relaxed pl-3 border-l-2 border-zinc-200 dark:border-white/10">Elegidas para el ciclo. Ejemplos: construcciones pioneras, técnicas de supervivencia, safaris fotográficos urbanos, primeros auxilios o iniciativas ecológicas locales.</p></div>
            </div>
          </div>
        </div>
      </div>
...
function TropaMistica({ primario }: { primario: string }) {
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-4">
          <span className="text-[0.8em] font-black uppercase tracking-widest px-3 py-1 rounded-full bg-green-100 dark:bg-green-950/40 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-900/30">Compromiso de Honor</span>
          <h4 className="font-extrabold uppercase text-[1.3em] text-zinc-900 dark:text-white leading-tight">La Promesa Scout</h4>
          <p className="text-[1.08em] leading-relaxed text-zinc-700 dark:text-zinc-300 italic pl-4 border-l-2 border-green-600">"Por mi honor prometo hacer cuanto de mí dependa para buscar a Dios, amar a mi familia, ayudar a los demás, servir a mi país, trabajar por la paz y vivir la Ley Scout."</p>
        </div>
        <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-4">
          ...
          <h4 className="font-extrabold uppercase text-[1.3em] text-zinc-900 dark:text-white leading-tight">La Ley Scout</h4>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-2 relative overflow-hidden"><div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: primario }} /><h4 className="font-extrabold uppercase text-[1.05em] text-zinc-900 dark:text-white pl-2">El Color Verde</h4><p className="text-[0.88em] text-zinc-650 dark:text-zinc-400 leading-relaxed pl-2">Color histórico de la primera rama en crearse. Baden-Powell adoptó el verde del Transvaal en las primeras insignias scouts bordadas en amarillo.</p></div>
        <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-2 relative overflow-hidden"><div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: '#fac620' }} /><h4 className="font-extrabold uppercase text-[1.05em] text-zinc-900 dark:text-white pl-2">La Flor de Lis</h4><p className="text-[0.88em] text-zinc-650 dark:text-zinc-400 leading-relaxed pl-2">Indica la buena senda en la rosa de los vientos de los antiguos mapas. Recuerda a todo scout mantener su ideal y señalar el norte correcto.</p></div>
        <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-2 relative overflow-hidden"><div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: primario }} /><h4 className="font-extrabold uppercase text-[1.05em] text-zinc-900 dark:text-white pl-2">Saludo Scout</h4><p className="text-[0.88em] text-zinc-650 dark:text-zinc-400 leading-relaxed pl-2">Dedo pulgar sobre el meñique (el fuerte protege al débil) y tres dedos alzados (las tres partes de la promesa), levantado a la altura del hombro.</p></div>
        <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-2 relative overflow-hidden"><div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: '#fac620' }} /><h4 className="font-extrabold uppercase text-[1.05em] text-zinc-900 dark:text-white pl-2">Buena Acción</h4><p className="text-[0.88em] text-zinc-650 dark:text-zinc-400 leading-relaxed pl-2">Compromiso diario de servicio tangible y concreto hacia los demás, combatiendo la indiferencia y poniendo de manifiesto al prójimo.</p></div>
      </div>
      ...
      <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-3 relative overflow-hidden">
        ...
        <h4 className="font-extrabold uppercase text-[1.25em] text-zinc-900 dark:text-white pl-2">La Oración Scout</h4>
        <p className="italic text-zinc-650 dark:text-zinc-400 leading-relaxed pl-4 border-l-2 border-green-500 max-w-xl text-[1.05em]">"Señor,<br />enséñanos a ser generosos,<br />a servirte como lo mereces,<br />a dar sin medida,<br />a combatir sin miedo a que nos hieran,<br />a trabajar sin descanso<br />y a no buscar otra recompensa<br />que saber que hacemos Tu voluntad."</p>
      </div>
      <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-3xl p-6 space-y-4 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1" style={{ backgroundColor: primario }} />
        <h4 className="font-extrabold uppercase text-[1.2em] text-zinc-900 dark:text-white pl-2">Himno de la Rama: Avanzan las Patrullas</h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[0.95em] pl-2">
          <div className="space-y-1"><span className="font-bold text-zinc-800 dark:text-zinc-200 block text-[0.9em] uppercase tracking-wide">Coro</span><p className="italic text-zinc-650 dark:text-zinc-400 leading-relaxed pl-3 border-l border-zinc-200 dark:border-white/10">Juntos escalemos la montaña altiva,<br />juntos escalemos el picacho azul.<br />Solo los halcones sobre nuestras frentes<br />giran majestuosos en el cielo azul.</p></div>
          <div className="space-y-1"><span className="font-bold text-zinc-800 dark:text-zinc-200 block text-[0.9em] uppercase tracking-wide">Estrofa I</span><p className="italic text-zinc-650 dark:text-zinc-400 leading-relaxed pl-3 border-l border-zinc-200 dark:border-white/10">Avanzan las patrullas,<br />a lo lejos, adelante.<br />Avanzan las patrullas<br />al toque del tambor. ¡Adelante!</p></div>
        </div>
      </div>
      <div className="relative rounded-[2rem] overflow-hidden border border-zinc-200 dark:border-white/10 bg-zinc-900 shadow-xl" style={{ minHeight: '280px' }}>
        <div className="absolute inset-0 z-0 select-none pointer-events-none opacity-40 dark:opacity-30"><img src="/images/unidades/bandera_tropa_1.jpg" alt="Bandera de la Tropa A'ata" className="w-full h-full object-cover" /></div>
        <div className="relative z-10 p-8 sm:p-10 flex flex-col justify-end h-full space-y-4 max-w-2xl bg-gradient-to-t from-zinc-950/90 via-zinc-950/40 to-transparent">
          <span className="text-[0.8em] font-black uppercase tracking-widest px-3 py-1 rounded-full bg-green-500/20 text-green-300 border border-green-500/30 self-start">Símbolo de Hermandad</span>
          <h4 className="text-[1.5em] font-black uppercase tracking-tight text-white leading-tight">La Bandera de la Tropa A'ata</h4>
          <p className="text-[1.02em] leading-relaxed text-zinc-200">La bandera oficial de la Rama Scouts lleva como fondo el color <strong>verde</strong> y en su centro, en color blanco, el diseño de la <strong>flor de lis</strong> utilizada en la insignia Scout Mundial.</p>
        </div>
      </div>
    </div>
  );
