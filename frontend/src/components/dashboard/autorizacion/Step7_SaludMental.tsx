          ...
          <div className="space-y-4 animate-in slide-in-from-top-4 duration-500">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                {['Si', 'No'].map(o => {
                  ...
                  return (
                    <label key={o} className={`flex-1 p-2 border-2 rounded-xl text-center cursor-pointer font-bold uppercase text-[0.9em] tracking-widest transition-all ${isChecked ? 'border-clr4 bg-clr4 text-clr1 shadow-lg' : 'border-clr7 dark:border-dclr7 dark:text-dclr2'}`}>
            ...
            <div className="space-y-1">
              <FieldInfo 
                ...
                info="Indique si está consumiendo algún Tipo de medicamento <br></br><br></br>(**indique cual y su horario**) <br></br><br></br>Si no consume, por favor escriba <b>No Consume</b>.<br></br><br></br><span class='font-black text-clr4'>* Este campo es obligatorio</span>" 
              />
              <textarea 
