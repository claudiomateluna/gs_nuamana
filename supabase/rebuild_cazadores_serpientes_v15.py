...
# 1. Process image with the new clean & simple title: "Cazadores de Serpientes"
raw_img = r'C:\Users\claud\.gemini\antigravity-cli\brain\1a6629cd-bb47-41eb-8e2a-da64d2f5d41e\cazadora_serpientes_v4_1784944416814.jpg'
out_img = r'frontend/public/uploads/actividad_cazadoresSerpientes.webp'
process_article_image_py(raw_img, out_img, 'Cazadores de Serpientes', 'Juegos')
...
<p><strong>Cazadores de Serpientes</strong> es un apasionante y dinámico juego scout de agilidad, atención alerta y velocidad de reacción. Los participantes orbitan en un círculo alrededor de un conjunto de cuerdas dispersas en el terreno, compitiendo velozmente por capturar una al escuchar la señal auditiva del dirigente.</p>
...
BEGIN
  ...
  DELETE FROM articulos WHERE slug IN ('la-cazadora-de-serpientes-reflejos-al-acecho', 'cazadores-de-serpientes');
  ...
  INSERT INTO articulos (
    ...
    '/uploads/actividad_cazadoresSerpientes.webp',
    'publicado',
...
with open("supabase/import_cazadores_serpientes_v15.sql", "wb") as f:
    f.write(sql_script.encode("utf-8"))

print("Simple title update complete: SQL generated for Cazadores de Serpientes.")
