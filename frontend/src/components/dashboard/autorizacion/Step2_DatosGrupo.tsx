        ...
        <Field fullWidth label="¿A que grupo Guía y Scout perteneces?" info="Seleccione el grupo guía / scout al que pertenece el niño, niña o joven, normalmente debería ser Nua Mana. *Este Dato es Obligatorio">
          <div className="flex gap-4">
            {['Guias y Scouts Nua Mana', 'Otro'].map(g => {
              ...
              return (
                <label key={g} className={`flex-1 p-3 border-2 rounded-xl text-center cursor-pointer font-bold uppercase text-[0.9em] tracking-widest transition-all ${isChecked ? 'border-clr7 bg-clr7 text-white shadow-lg scale-105' : 'border-zinc-200 dark:border-dclr10 dark:text-dclr2 hover:border-clr7/30'}`}>
