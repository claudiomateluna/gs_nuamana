...
# Terminal Text 1: "Reconoce el matrimonio y la familia como base de la sociedad, convirtiendo la suya en una comunidad de amor conyugal, filial y fraterno."
# Terminal Text 2: "Vive su libertad de un modo solidario, ejerciendo sus derechos, cumpliendo sus obligaciones y defendiendo igual derecho para los demás."

objetivos_educativos = [
    # ==================== TERMINAL TEXT 1: FAMILIA ====================
    # --- Manada (Infancia Media 7-9 años) ---
    {
        ...
        "unidad": "Manada",
        "como_se_cumple": "Expresando afecto y compañerismo de manera positiva al responder las consignas familiares en el tablero del nido."
    },
    {
        ...
        "unidad": "Manada",
        "como_se_cumple": "Compartiendo anécdotas alegres sobre mi hogar y valorando a mi familia durante el juego."
    },
    ...
    },
    {
        ...
        "unidad": "Manada",
        "como_se_cumple": "Escuchando con respeto las costumbres familiares que comparten otros lobatos en las casillas."
    },
    ...
    # --- Tropa (11 a 13 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Relatando cómo colaboro activamente con mi familia en las tareas del hogar al caer en las casillas de diálogo."
    },
    {
        "id": "4f07f03b-46ab-4dba-b0c7-3faa33cf3a72",
        "area": "Afectividad",
        "texto": "Le cuento a mi familia lo que hacemos en los scouts y trato que ellos participen en las actividades.",
        "unidad": "Tropa",
        "como_se_cumple": "Expresando el orgullo de integrar a mi familia en el movimiento scout durante las intervenciones del nido."
    },
    # --- Tropa (13 a 15 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Reflexionando con madurez sobre la importancia de la armonía y la convivencia familiar."
    },
    {
        "id": "5c103fdc-0d8d-4624-8df4-94d2f6cca951",
        "area": "Afectividad",
        "texto": "Converso con mis padres sobre lo que consideran bueno para mí y mis hermanos y hermanas.",
        "unidad": "Tropa",
        "como_se_cumple": "Valorando la comunicación franca con mis padres al responder preguntas sobre metas personales."
    },
    ...
    # --- Compañía (11 a 13 años) ---
    {
        ...
        "texto": "Me gusta hacer cosas con mi familia y ayudo en lo que me piden para organizarlas.",
        "unidad": "Compañía",
        "como_se_cumple": "Compartiendo experiencias de cooperación familiar con mis compañeras de patrulla."
    },
    {
        "id": "a55b8cc7-5752-4f78-bd08-5d4ede63a3c0",
        "area": "Afectividad",
        "texto": "Le cuento a mi familia lo que hacemos en las guías y trato que ellos participen en las actividades.",
        "unidad": "Compañía",
        "como_se_cumple": "Platicando cómo transmito los ideales guías a mi entorno familiar."
    },
    # --- Compañía (13 a 15 años) ---
    {
        "id": "ceaa05c0-48ca-49dd-9885-393a8c4707de",
        "area": "Afectividad",
        "texto": "Converso con mis padres sobre lo que consideran bueno para mí y mis hermanos y hermanas.",
        "unidad": "Compañía",
        "como_se_cumple": "Expresando reflexiones sobre la orientación y valores que recibo de mis padres."
    },
    {
        ...
        "unidad": "Compañía",
        "como_se_cumple": "Promoviendo el afecto y la aceptación de acuerdos familiares en el tablero."
    },
    ...
    # --- Avanzada (15 a 17 años) ---
    {
        ...
        "unidad": "Avanzada",
        "como_se_cumple": "Analizando con madurez el diálogo intergeneracional y el afecto filial en la comunidad caminante."
    },
    {
        "id": "8de78b0e-6abc-417a-a70a-77fbe8642778",
        "area": "Afectividad",
        "texto": "Converso y comparto con mis hermanos y hermanas y aprendo de nuestra relación.",
        "unidad": "Avanzada",
        "como_se_cumple": "Aportando vivencias de fraternidad y apoyo mutuo entre hermanos durante el intercambio."
    },

    # ==================== TERMINAL TEXT 2: LIBERTAD SOLIDARIA / DERECHOS ====================
    # --- Manada (Infancia Media 7-9 años) ---
    {
        ...
        "unidad": "Manada",
        "como_se_cumple": "Compartiendo de manera generosa mis materiales, fichas y vivencias con la seisena."
    },
    {
        "id": "a5c8bf0d-4e75-4f7a-89a2-9feabf5ec808",
        "area": "Sociabilidad",
        "texto": "Participo en juegos y actividades sobre los derechos del niño.",
        "unidad": "Manada",
        "como_se_cumple": "Jugando alegremente y respetando el derecho de todos a expresarse libremente."
    },
    # --- Manada (Infancia Tardía 9-11 años) ---
    {
        ...
        "unidad": "Manada",
        "como_se_cumple": "Escuchando con atención las respuestas de otros lobatos sin interrumpir ni criticar."
    },
    {
        "id": "d15e8733-8e84-44e4-9e9c-f8090e201b6e",
        "area": "Sociabilidad",
        "texto": "Conozco los derechos del niño y los relaciono con situaciones que conozco o con otras de las que he oído hablar.",
        "unidad": "Manada",
        "como_se_cumple": "Relacionando el derecho al juego y a la libertad de expresión con la dinámica en el tablero."
    },
    ...
    # --- Tropa (11 a 13 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Promoviendo el respeto y la inclusión hacia todos los integrantes de la patrulla."
    },
    {
        "id": "9c8c7e3e-0d7c-45e7-9154-2dc5ed6a85e3",
        "area": "Sociabilidad",
        "texto": "Converso con mi patrulla sobre los derechos humanos.",
        "unidad": "Tropa",
        "como_se_cumple": "Proponiendo temas de justicia social y derechos humanos en las casillas del nido."
    },
    # --- Tropa (13 a 15 años) ---
    {
        ...
        "unidad": "Tropa",
        "como_se_cumple": "Demostrando tolerancia y apertura frente a las diferencias de pensamiento en el grupo."
    },
    {
        "id": "234b7941-49cb-4656-8080-d30b65cf0029",
        "area": "Sociabilidad",
        "texto": "No me gusta cuando no se respetan los derechos humanos y lo digo.",
        "unidad": "Tropa",
        "como_se_cumple": "Manifestando una postura firme y respetuosa contra el maltrato o la discriminación."
    },
    ...
    # --- Compañía (11 a 13 años) ---
    {
        ...
        "unidad": "Compañía",
        "como_se_cumple": "Fomentando el respeto a la diversidad dentro de la patrulla de guías."
    },
    {
        "id": "670852e4-d07d-48f5-b39b-b0b336059600",
        "area": "Sociabilidad",
        "texto": "Converso con mi patrulla sobre los derechos humanos.",
        "unidad": "Compañía",
        "como_se_cumple": "Dialogando sobre la equidad y la dignidad humana durante el recorrido del juego."
    },
    # --- Compañía (13 a 15 años) ---
    {
        ...
        "texto": "Respeto a todas las personas, independientemente de sus ideas, su clase social y su forma de vida.",
        "unidad": "Compañía",
        "como_se_cumple": "Defendiendo valores de inclusión y dignidad igualitaria al intervenir en las casillas."
    },
    {
        "id": "944660c8-0093-4181-ba2c-5f95cc74ba47",
        "area": "Sociabilidad",
        "texto": "No me gusta cuando no se respetan los derechos humanos y lo digo.",
        "unidad": "Compañía",
        "como_se_cumple": "Expresando rechazo consciente ante injusticias sociales durante el diálogo reflexivo."
    },
    ...
    # --- Avanzada (15 a 17 años) ---
    {
        ...
        "unidad": "Avanzada",
        "como_se_cumple": "Fundamentando la igualdad de dignidad como principio rector en mis relaciones comunitarias."
    },
    {
        "id": "97b83994-e34f-4a8d-89b5-9899995b3a04",
        "area": "Sociabilidad",
        "texto": "Asumo una posición activa frente a los atropellos a las personas que observo en mi vida cotidiana.",
        "unidad": "Avanzada",
        "como_se_cumple": "Asumiendo compromisos concretos de defensa de los derechos de los más vulnerables."
    }
]
...
with open("supabase/update_el_nido_v3.sql", "wb") as f:
    f.write(sql_script.encode("utf-8"))

print("V3 SQL generated cleanly with dollar quoting and full terminal chains.")
