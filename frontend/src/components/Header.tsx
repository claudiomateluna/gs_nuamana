        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/" className="flex items-center group">
            ...
            <div className="sm:flex flex-col ml-1 md:ml-3 justify-center">
              <div className="text-[0.7em] md:text-[0.8em] text-clr2 uppercase font-black tracking-widest leading-none mb-[-1px]">Guías y Scouts</div>
              <div className="text-[1em] md:text-[1.5em] text-white font-black uppercase leading-none tracking-tighter font-inika">Nua Mana</div>
              <div className="text-[0.7em] md:text-[0.85em] text-clr8 italic leading-none mt-[-6px]">una nueva aventura</div>
            </div>
          </Link>
        </div>
